...
// first,next,best,worst fit algorithm implementaton example
// for testing the algorithms there are given values to blocks from [5000,140000]
// time,memory and blocks are counted in order to present how each algorithm works for this simple task


//first_fit implementation
